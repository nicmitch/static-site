...
<script>
	...
	var messaggio_errore_mail = "<?php echo $texts['form_validationMail']; ?>";
        ...
        */ ?>
		...
		<!-- build:js /italianfood/js/build.js -->
		...
		<script type="text/javascript" src="../bower_components/adapt-img/adapt-img.js"></script>

		<script type="text/javascript" src="../form/placeholder.js"></script>
		<script type="text/javascript" src="../form/validation.js"></script>
		<script type="text/javascript" src="../js/script.js"></script>
		<!-- endbuild -->
		
		<?php /*
		<script src="http://www.nicolamerici.com/cookies/cookies.js"></script>
		<script>
			COOKIES_ENABLER.init({
	       		//privacyLink: '/it/privacy.php',
	    	});
		</script>
		*/ ?>
